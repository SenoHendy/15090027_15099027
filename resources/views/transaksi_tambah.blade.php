...
<div class="container">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/transaksi/create" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="pelanggan_id" class="form-control" placeholder="Masukan Pelanggan Id"></input>
                        ...
                        <div class="form-group">
                            ...
                            <input name="sopir_id" class="form-control" placeholder="Masukan Sopir ID"></input>
                        ...
                        <div class="form-group">
                            ...
                            <input name="transaksi_tglmulai" class="form-control" placeholder="Masukan Transaksi Tanggal Mulai"></input>
                        ...
                        <div class="form-group">
                            ...
                            <input name="transaksi_status" class="form-control" placeholder="Masukan Transaksi Status"></input>
